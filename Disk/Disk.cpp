...
// Disk.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CDiskApp, CWinApp)
...
// Единственный объект CDiskApp

CDiskApp theApp;


// Инициализация CDiskApp

BOOL CDiskApp::InitInstance()
{
